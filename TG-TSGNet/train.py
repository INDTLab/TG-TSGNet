...
from dalle_pytorch.dalle_pytorch_simple import OpenAIDiscreteVAE, VQGanVAE, DiscreteVAE, DALLE
from dalle_pytorch import distributed_utils
# from dalle_pytorch.loader2 import TextImageDataset
...
save_dir = "/data1/yifan/DALLE-pytorch-main/wandb/"
...
train_group.add_argument('--epochs', default = 150, type = int, help = 'Number of epochs')
...
model_group.add_argument('--depth', default = 1, type = int, help = 'Model depth')

model_group.add_argument('--mamba_depth', default=1, type=int, help='Depth of mamba blocks')
...
model_group.add_argument('--attn_types', default = 'full', type = str, help = 'comma separated list of attention types. attention type can be: full or sparse or axial_row or axial_col or conv_like or multi.')
...
if ENABLE_WEBDATASET:
    ...
    ds = TextImageDataset(
        ...
        # image_root="/data1/yifan/data/underwater/train/img/",
        # json_path="/data1/yifan/Tools/gemma3_refined_descriptions.json",
...
for epoch in range(resume_epoch, EPOCHS):
    ...
    for i, (text, images) in enumerate((dl if ENABLE_WEBDATASET else distr_dl)):
        ...
        if avg_loss.item() < best_loss:
            ...
            save_model(DALLE_OUTPUT_FILE_NAME.replace('.pt', f'_best_loss.pt'), epoch=epoch)
