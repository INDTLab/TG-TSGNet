...
class Encoder(nn.Module):
    def __init__(self, *, ch, ch_mult=(1, 2, 4, 8), num_res_blocks,
        ...
        self.one.up1 = Upsample(ch*2, ch, resamp_with_conv)
        self.one.up2 = Upsample(ch*4, ch*2, resamp_with_conv)
        # self.one.up3 = Upsample(ch*8, ch*4, resamp_with_conv)
    ...
    def forward(self, x):
        ...
        h1 = self.one.block_2(h)

        
        h = self.one.reduction1(h1)
