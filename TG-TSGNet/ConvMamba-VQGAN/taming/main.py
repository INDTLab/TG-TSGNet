...
if __name__ == "__main__":
    ...
    try:
        ...
        trainer = Trainer.from_argparse_args(trainer_opt, check_val_every_n_epoch=5, max_epochs=100, resume_from_checkpoint=os.path.join("/data1/yifan/taming-transformers-master/logs/2024-11-18T19-15-20_vqgan_tcm18/checkpoints/last.ckpt"), **trainer_kwargs)
